...
### Train a Disentangled RNN

```python
from disRNN_MP.rnn import hkDisRNN, ModelTrainee

# TODO: Add working example
```

### Run Agent-Environment Simulation

```python
from disRNN_MP.agent import RL_watcher, hkNetwork_multiAgent
...
```python
from disRNN_MP.analysis import BanditDataset
...
Full documentation will be available at: **https://horizonp.github.io/disRNN-MP/**
